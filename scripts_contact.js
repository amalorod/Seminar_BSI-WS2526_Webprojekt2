...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const alleIDs = [
    'fname', 'lname', 'name', 'alter', 'hund', 'katze', 'maus',
    'Fussball', 'Basketball', 'Volleyball', 'eigeneMeinung', 'attention'
  ];
  ...
  btn.addEventListener('click', function (event) {
    ...
    ergebnisAnzeige.innerHTML = "<strong>Erfasste Daten:</strong><br>" + " " + text; //Ausgeben
...
      'maus': 'Lieblingstier',
      'Fussball': 'Interessen',
      'Basketball': 'Interessen',
      'Volleyball': 'Interessen',
...
    
    return "Du hast nichts angegeben";
  }
...
      resultText += `•${key}:${collectedData[key].join('<br>')}<br>`;
    } else {
